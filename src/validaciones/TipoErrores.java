...
public abstract class TipoErrores {
	...
	static final String MSJ_CONTIENE_SIMBOLOS= "El campo no puede contener números o símbolos";
	...
	public static String getMSJ_CONTIENE_SIMBOLOS() {
		return MSJ_CONTIENE_SIMBOLOS;
	}
